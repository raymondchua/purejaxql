...
# Run the experiment
python purejaxql/pqn_sf_craftax.py +alg=pqn_sf_craftax SEED=${SEED} SAVE_PATH=${OUT_DIR} PROJECT="Craftax" alg.FEATURE_DIM=16 alg.SF_DIM=32 alg.SOFT_ENTROPY=true